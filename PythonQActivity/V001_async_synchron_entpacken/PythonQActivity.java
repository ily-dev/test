...
public class PythonQActivity extends Activity {
    ...
    private void updateProgress(int percent, String message) {
        mHandler.post(() -> {
            if (mProgressDialog != null && mProgressDialog.isShowing()) {
                ...
                mProgressDialog.setMessage(message != null ? message : "Entpacke... " + percent + "%");
    ...
    private void hideProgressDialog() {
        mHandler.post(() -> {
            if (mProgressDialog != null && mProgressDialog.isShowing()) {
                ...
                showLog(TAG, "✅ Dialog ausgeblendet");
            }
        });
    }
    ...
    // ------------------------------------------------------------------------
    // ASYNCHRONES ENTPACKEN
    // ------------------------------------------------------------------------
    private void startAsyncUnpack() {
        showProgressDialog("Entpacke Dateien...", "Initialisiere...");
        
        // ★★★ PythonUtil.unpackAssetAsync AUFRUFEN ★★★
        PythonUtil.unpackAssetAsync(
            this,
            "private",
            targetDir,
            true,
            new PythonUtil.ProgressCallback() {  // ★ PythonUtil.ProgressCallback
                @Override
    ...
    private void unpackPyBundleAsync() {
        updateProgress(50, "Entpacke PyBundle...");
    ...
    // ★★★ WIRD NACH ERFOLGREICHEM ENTPACKEN AUFGERUFEN ★★★
    private void onUnpackComplete() {
        showLog(TAG, "✅ Entpacken abgeschlossen!");
        
        // ★★★ UMWELTVARIABLEN SETZEN ★★★
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        targetDir = new File(getAppRoot());
        startAsyncUnpack();  // ← Hier wird die asynchrone Methode aufgerufen
    }
